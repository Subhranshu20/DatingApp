...
namespace api.Data.Migrations
{
    ...
    [Migration("20210702165005_IdentityAdded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("api.Entity.ApiUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("api.Entity.ApiUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("api.Entity.AppUserRole", b =>
                {
                    ...
                    b.HasOne("api.Entity.ApiUser", "User")
                        .WithMany("UserRoles")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("api.Entity.Message", b =>
                {
                    b.HasOne("api.Entity.ApiUser", "Recipient")
                        .WithMany("MessagesReceived")
                        .HasForeignKey("RecipientId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("api.Entity.ApiUser", "Sender")
            ...
            modelBuilder.Entity("api.Entity.Photo", b =>
                {
                    b.HasOne("api.Entity.ApiUser", "ApiUser")
                        .WithMany("Photos")
            ...
            modelBuilder.Entity("api.Entity.UserLike", b =>
                {
                    b.HasOne("api.Entity.ApiUser", "LikeUser")
                        .WithMany("LikedByUsers")
                        .HasForeignKey("LikeUserID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("api.Entity.ApiUser", "SourceUser")
                        .WithMany("LikedUsers")
